...
func NewMovieRepository(db *sql.DB, log *logger.Logger) (*MovieRepositoryImpl, error) {
...
func (r *MovieRepositoryImpl) GetTopMovies() ([]models.Movie, error) {
	query := `
...
func (r *MovieRepositoryImpl) GetRandomMovies() ([]models.Movie, error) {
	query := `
		SELECT id, tmdb_id, title, tagline, release_year, overview, score,
		  	popularity, language, poster_url, trailer_url
		FROM movies
...
func (r *MovieRepositoryImpl) GetMovieByID(id int) (models.Movie, error) {
	// Fetch movie
	query := `
		SELECT id, tmdb_id, title, tagline, release_year, overview, score,
		       popularity, language, poster_url, trailer_url
...
func (r *MovieRepositoryImpl) SearchMoviesByName(name string, order string, genre *int) ([]models.Movie, error) {
...
func (r *MovieRepositoryImpl) GetAllGenres() ([]models.Genre, error) {
...
func (r *MovieRepositoryImpl) fetchMovieRelations(m *models.Movie) error {
	// Fetch genres
	genreQuery := `
		SELECT g.id, g.name
		FROM genres g
...
func (r *MovieRepositoryImpl) getMovies(query string) ([]models.Movie, error) {
